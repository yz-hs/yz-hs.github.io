var yourLinkOfSite = "https://yz-hs.github.io/projects/door/"
...
function linkChangey(){
	if(yourMessage.value==""){
		yourLink.value = yourLinkOfSite;
	}else{
		yourLink.value = yourLinkOfSite + "#" + encodeURIComponent(encryptString(yourMessage.value));
	}
};
